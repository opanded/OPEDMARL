...
python3 -m maddpg_o.experiments.train_normal \
    ...
    --save-dir="./result/adversarial/mean_field/8agents/8agents_1/" \
    --save-rate=1 \
    --max-num-train=2000\
...
python3 -m maddpg_o.experiments.train_normal \
    ...
    --save-dir="./result/adversarial/mean_field/16agents/16agents_1/" \
    --save-rate=1 \
    --max-num-train=2000\
...
python3 -m maddpg_o.experiments.train_normal \
    ...
    --save-dir="./result/adversarial/mean_field/32agents/32agents_1/" \
    --save-rate=1 \
    --max-num-train=1000\
...
python3 -m maddpg_o.experiments.train_normal \
    ...
    --save-dir="./result/adversarial/mean_field/64agents/64agents_1/" \
    --save-rate=1 \
    --max-num-train=500\
